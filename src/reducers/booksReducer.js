const initialState = {
  ...
  data: {
    continueReading: {
      ...
      emptyMessage:
        "Books you are currently reading will be shown here.\nLooks like you aren't reading anything right now!",
      totalItems: 0,
      startIndex: 0,
      payload: [],
    },
      ...
      const newState = {
        ...
        data: {
          ...
          continueReading: {
            ...
            startIndex:
              continueData.totalItems > 0 ? continueData.items.length : 0,
          },
          favorites: {
            ...
            startIndex:
              favoritesData.totalItems > 0 ? favoritesData.items.length : 0,
          },
          myBooks: {
            ...
            startIndex:
              myBooksData.totalItems > 0 ? myBooksData.items.length : 0,
          },
          purchased: {
            ...
            startIndex:
              purchasedData.totalItems > 0 ? purchasedData.items.length : 0,
          },
          recommended: {
            ...initialState.data.recommended,
            payload:
              recommendedData.totalItems > 0 ? recommendedData.items : [],
            totalItems: recommendedData.totalItems,
            startIndex:
              recommendedData.totalItems > 0 ? recommendedData.items.length : 0,
          },
        },
        loading: false,
      };
